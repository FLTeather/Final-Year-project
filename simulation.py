...
class simulation():
    ...
    def addCreature(self, name, hp, ac, y, x, pp):
        creature = Creature(name, hp, ac, pp, self.battelfield)
        self.battelfield.addCreature(creature, y, x)
        self.creatures.append(creature)
        self.battelfield.printBattelfield()

    def random(self):
        self.addCreature("John", 2, 10, 2, 4, 15)
...
sim.battelfield.allCreatures[0].hide()
print(sim.battelfield.allCreatures[0].isHidden)
